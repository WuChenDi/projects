...
export function Cascader({
  ...
  const triggerElement = (
    <div
      ...
      className={cn(
        "inline-flex items-center justify-between gap-1.5 whitespace-nowrap rounded-lg text-sm ring-offset-background transition-colors",
        "dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:aria-invalid:border-destructive/50 border bg-transparent transition-colors select-none focus-visible:ring-3 aria-invalid:ring-3",
        "border border-input bg-background dark:bg-input/30 dark:hover:bg-input/50 ",
        "data-[size=sm]:rounded-[min(var(--radius-md),10px)] *:data-[slot=select-value]:gap-1.5 [&_svg:not([class*='size-'])]:size-4 outline-none *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center [&_svg]:pointer-events-none [&_svg]:shrink-0",
        "h-8 px-2 py-1 w-[200px] cursor-pointer",
