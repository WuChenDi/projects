/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 0459eddc5cc4eb51380f7ee75b7cc917)
// Runtime types generated with workerd@1.20260611.1 2026-05-25 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	...
	REDIRECT_WITH_QUERY: string;
	HOME_URL: string;
	NOT_FOUND_REDIRECT: string;
	CASE_SENSITIVE: string;
	SLUG_DEFAULT_LENGTH: string;
	LIST_QUERY_LIMIT: string;
	DATASET: string;
	DISABLE_BOT_ACCESS_LOG: string;
	AI_MODEL: string;
	AI_PROMPT: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "account_id" | "NEGATIVE_CACHE_TTL" | "SAFE_BROWSING_DOH" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "DB_TYPE" | "LIBSQL_URL" | "LIBSQL_AUTH_TOKEN" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_API_TOKEN" | "CLOUDFLARE_DATABASE_ID" | "REDIRECT_STATUS_CODE" | "LINK_CACHE_TTL" | "REDIRECT_WITH_QUERY" | "HOME_URL" | "NOT_FOUND_REDIRECT" | "CASE_SENSITIVE" | "SLUG_DEFAULT_LENGTH" | "LIST_QUERY_LIMIT" | "DATASET" | "DISABLE_BOT_ACCESS_LOG" | "AI_MODEL" | "AI_PROMPT">> {}
}
