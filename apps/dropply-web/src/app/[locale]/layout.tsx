          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              featureList: [
                ...
                'Local in-browser file encryption and decryption',
                'Password and public-key encryption modes',
                'Share encrypted files via retrieval code',
                'Optional email delivery of retrieval codes',
                'No account required',
