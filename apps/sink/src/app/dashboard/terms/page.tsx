        ...
        <div className="flex flex-col gap-8 text-[0.9375rem] leading-relaxed text-foreground/90 sm:text-base">
          <section className="flex flex-col gap-3">
            ...
            <p>
              ...
              and edge analytics. These terms govern your use of the Sink
          ...
          <section className="flex flex-col gap-3">
            ...
            <p>
              You agree not to use Sink to create or distribute links to content
          ...
          <section className="flex flex-col gap-3">
            ...
            <p>
              Sink is provided <strong>&quot;as is&quot;</strong> and{' '}
          ...
          <section className="flex flex-col gap-3">
            ...
            <p>
              To the fullest extent permitted by law, Sink and its maintainers
