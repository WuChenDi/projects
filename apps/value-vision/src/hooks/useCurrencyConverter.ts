...
import type { ConverterField, ExchangeRates } from '@/types/currency'
...
export const useCurrencyConverter = (rates: ExchangeRates) => {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: re-convert only when rates arrive; convert/fields deps would re-trigger on every conversion
  useEffect(() => {
