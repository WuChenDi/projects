...
interface UseControlsVisibilityProps {
  ...
  controlsTimeoutRef: React.RefObject<NodeJS.Timeout | null>
  speedMenuTimeoutRef: React.RefObject<NodeJS.Timeout | null>
  mouseMoveThrottleRef: React.RefObject<NodeJS.Timeout | null>
}
...
export function useControlsVisibility({
  ...
  }, [isPlaying, showSpeedMenu, controlsTimeoutRef, showMoreMenu, hideControls])
