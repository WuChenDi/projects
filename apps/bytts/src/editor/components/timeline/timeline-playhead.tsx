...
// Playhead line + drag handle. Ported from bycut, trimmed of keyboard nudging
// (frame-step arrows land with the shortcut work in FEAT-027).
...
export function TimelinePlayhead({
  ...
  useEffect(() => {
    ...
    return () => scrollContainer.removeEventListener('scroll', syncScrollOffset)
  ...
  return (
    ...
    >
      ...
      <div className="bg-foreground border-foreground/50 absolute top-1 left-1/2 size-3 -translate-x-1/2 transform rounded-full border-2 shadow-xs" />
    </div>
  )
}
