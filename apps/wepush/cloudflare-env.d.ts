/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 28ff284811aac825f273f27b48b2f23b)
// Runtime types generated with workerd@1.20260710.1 2026-07-16 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	PUSH_QUEUE: Queue;
	ASSETS: Fetcher;
	BETTER_AUTH_URL: "https://wepush.cdlab.workers.dev";
	DB_TYPE: "d1";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "DB_TYPE" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "LIBSQL_URL" | "LIBSQL_AUTH_TOKEN" | "NEXT_PUBLIC_BETTER_AUTH_URL">> {}
}
