...
export const EXPERT_ROLES: ExpertRole[] = [
	{
		id: "auto",
		getLabel: () => i18next.t("agent.autoDirector"),
		getDescription: () =>
			i18next.t(
	...
	{
		id: "general",
		getLabel: () => i18next.t("agent.generalAssistant"),
		getDescription: () => i18next.t("agent.generalAssistantDesc"),
		systemPromptAddition: "",
	},
	{
		id: "design",
		getLabel: () => i18next.t("agent.designConsultant"),
		getDescription: () =>
			i18next.t("agent.designConsultantDesc"),
		systemPromptAddition: `
...
When the user asks general editing questions, still provide design-focused insights. Proactively suggest visual improvements when you notice opportunities.`,
	...
	{
		id: "audio",
		getLabel: () => i18next.t("agent.audioEditor"),
		getDescription: () =>
			i18next.t("agent.audioEditorDesc"),
		systemPromptAddition: `
...
When the user asks general editing questions, still provide audio-focused insights. Proactively suggest audio improvements when you notice opportunities.`,
	...
	{
		id: "editing",
		getLabel: () => i18next.t("agent.editingAdvisor"),
		getDescription: () =>
			i18next.t("agent.editingAdvisorDesc"),
		systemPromptAddition: `
...
When the user asks general editing questions, provide structure and pacing-focused insights. Proactively suggest editorial improvements when you notice opportunities.`,
	...
	{
		id: "storytelling",
		getLabel: () => i18next.t("agent.storyDirector"),
		getDescription: () =>
			i18next.t(
