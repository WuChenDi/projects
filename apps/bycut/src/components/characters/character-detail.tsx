        ...
        <DialogContent className="sm:max-w-2xl max-h-[80vh] overflow-y-auto">
          ...
          <div>
            ...
            {character.generations.length > 0 && (
              <div className="flex flex-col gap-2">
                <h4 className="text-sm font-medium">
                  {t('ai.generatedContentCount', {
                    num: character.generations.length,
                  })}
                </h4>
                <div className="grid grid-cols-2 gap-2">
                  {character.generations.map((generation, index) => (
                    <GenerationCard
                      key={generation.id}
    ...
    <div className="group relative overflow-hidden rounded-md border bg-muted/50">
      ...
      >
        ...
        <div className="absolute top-1 left-1">
          {isVideo ? (
            <Video className="size-3.5 text-white drop-shadow" />
          ) : (
            <Image className="size-3.5 text-white drop-shadow" />
          )}
        </div>
      </button>
      <div className="p-1.5">
