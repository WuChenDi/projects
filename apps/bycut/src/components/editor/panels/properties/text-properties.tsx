...
import { MAX_FONT_SIZE, MIN_FONT_SIZE } from '@/constants/text-constants'
import type { TextStylePreset } from '@/constants/text-style-presets'
import { TEXT_STYLE_PRESETS } from '@/constants/text-style-presets'
    ...
    <div className="flex h-full flex-col" ref={containerRef}>
      <Tabs defaultValue="style">
        <TabsList>
          ...
          <TabsTrigger value="speech">{t('assets.speech')}</TabsTrigger>
        </TabsList>
        <TabsContent value="style" className="mt-0 flex-1 overflow-auto">
          <PanelBaseView className="p-0">
            ...
            <PropertyGroup
              title={t('properties.typography')}
              collapsible={false}
            >
              <div className="space-y-6">
                {/* <PropertyItem direction="column">
                  <PropertyItemLabel>{t("properties.font")}</PropertyItemLabel>
                  <PropertyItemValue>
                    <FontPicker
                ...
                <PropertyItem direction="column">
                  <PropertyItemLabel>{t('common.style')}</PropertyItemLabel>
                  <PropertyItemValue>
            ...
            <PropertyGroup title={t('ai.presets')} collapsible={false}>
            ...
            >
              <div className="space-y-6">
                <PropertyItem>
                  <PropertyItemLabel>{t('common.enable')}</PropertyItemLabel>
                  <PropertyItemValue>
                    <Switch
            ...
            <PropertyGroup title={t('properties.transform')}>
              <div className="space-y-6">
                <PropertyItem>
                  <PropertyItemLabel>
                    {t('properties.positionX')}
                  </PropertyItemLabel>
                  <PropertyItemValue>
                    <Input
                      type="number"
