    ...
    generate: async () => {
      ...
      if (isDevPlaceholderActive()) {
        ...
        try {
          ...
          toast.success(i18next.t('ai.imagesGenerated', { num: 1 }))
          ...
          const message =
            error instanceof Error ? error.message : i18next.t('ai.imageFailed')
          toast.error(message)
      ...
      if (!imageProviderId) {
        toast.error(i18next.t('ai.configureImageProvider'))
        return
      }
